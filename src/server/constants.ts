...
export const ERRORS = {
  ...
  CONFIGURATION_DISCOVERY_FAILED: "Could not discover OpenID configuration",
  CONFIGURATION_DISCOVERY_RETRY_LATER: "OpenID configuration discovery is cooling down after a recent failure",
